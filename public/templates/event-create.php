...
<main class="main-content">
    <div class="page-header">
        ...
        <p class="greeting-sub">Samostatná stránka pre vytvorenie nového eventu.</p>
    </div>
    <div class="card">
        ...
        <div style="padding:0 1.5rem 1.5rem;">
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px,1fr)); gap:1rem; margin-bottom:1rem;">
                <div>
                    ...
                    <input type="text" placeholder="Zadaj názov eventu" style="width:100%; padding:0.85rem 1rem; border:1px solid var(--border-color); border-radius:12px; background:var(--surface-color); color:var(--text-primary);">
                </div>
                <div>
            ...
            <div style="margin-bottom:1rem;">
                ...
                <textarea rows="10" placeholder="Sem príde obsah eventu..." style="width:100%; padding:0.85rem 1rem; border:1px solid var(--border-color); border-radius:12px; background:var(--surface-color); color:var(--text-primary); resize:vertical;"></textarea>
            </div>
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px,1fr)); gap:1rem; margin-bottom:1rem;">
                <div>
            ...
            <div style="display:flex; gap:0.75rem; flex-wrap:wrap;">
                <a href="admin.php" class="btn">Save Event</a>
